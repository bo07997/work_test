...
class service:
    ...
    def timeout(self):
        ...
        data = {}
        data['thread'] = 'two'
        self.socket_to_others.send_string(zmqconfig.two_to_one_subject, zmq.SNDMORE)
        self.socket_to_others.send_string(json.dumps(data))
        self.socket_to_others.send_string(zmqconfig.two_to_three_subject, zmq.SNDMORE)
        self.socket_to_others.send_string(json.dumps(data))
    ...
    def run(self):
        ...
        self.socket_from_one.setsockopt_string(zmq.SUBSCRIBE, zmqconfig.one_to_two_subject)
        ...
        self.socket_from_three.setsockopt_string(zmq.SUBSCRIBE, zmqconfig.three_to_two_subject)
